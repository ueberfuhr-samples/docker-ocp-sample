...
**Please note**: The ArgoCD containers request disk-size and memory that the OpenShift node does not provide by default.
...
Unfortunately, after installing the ArgoCD application, the local CRC runs slowly. So it might be easier to switch to 
Minikube (see [details](https://redhat-scholars.github.io/argocd-tutorial/argocd-tutorial/01-setup.html)).
